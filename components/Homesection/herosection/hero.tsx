  ...
  return (
    <div className="w-[100%] flex justify-between ">
      <div className="w-3/5 flex flex-col gap-5">
        ...
        <h1 className="flex flex-wraps text-gray-900 text-lexend text-5xl font-normal font-semibold">
          <span>
        ...
        <div className="w-[70%] flex my-5" style={{position:"relative"}}>
          <div className="flex flex-col justify-between w-1/2 gap-5" style={{position:"relative"}}>
            ...
            <div className="flex ">
                <div>
                <p className="graphicsDesigner-block blocks">Graphics Designers </p>
            ...
            <p className="MotionDesigners-block blocks"> Motion Designers </p>
         </div>
            </div>
          </div>
